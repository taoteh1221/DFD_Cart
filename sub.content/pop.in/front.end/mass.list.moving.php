...
parent.document.getElementById("answers_title").innerHTML = '<b style="font-size: <?=$font_5?>px; color: #BC5938;">Choose Category to Move Into</b>';
...
<form name="update_form" action="index.php?key=<?=$_SESSION['sec_key']?>" method="post">
<div style="padding: 6px;"></div>
<div align="center" style="padding: 3px;"><b><u>***Mass Moving of Items***</u></b></div>
<?=$alert_status?>
<div style="padding: 9px;"></div>


<div align="center"><b>Move to Category:</b><br />
<?php
...
<div align="center">
<input type='button' value='Cancel' onclick='parent.document.mass_edit.selected_products.value = ""; parent.document.data_control.submit();' />&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="Move Items" onclick="parent.document.mass_edit.move_category.value = document.update_form.category.value; parent.document.mass_edit.submit();" />
