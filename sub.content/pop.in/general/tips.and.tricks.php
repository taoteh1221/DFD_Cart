...
parent.document.getElementById("answers_title").innerHTML = '<b style="font-size: <?=$font_5?>px; color: #BC5938;">Tips and Tricks</b>';
...
<div align="center" style="padding: 6px;"><a href="help.index.php" target="_self"><b>Return to Help Index</b></a></div>
 ...
 &nbsp;<b>List spreadsheet products by name, price, or category path</b> through the sorting features in your office software by selecting ALL products and their columns, then pick which column to base the sorting on.
