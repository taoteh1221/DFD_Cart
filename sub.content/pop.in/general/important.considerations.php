...
parent.document.getElementById("answers_title").innerHTML = '<b style="font-size: <?=$font_5?>px; color: #BC5938;">Considerations Before Editing</b>';
...
&nbsp;<b>When changing prices on existing items</b>, if customers are currently online and done updating their order <i>before</i> you changed them, these price changes will not be reflected in their order (it will warn them if you delete it though).
You may want to update currently existing item's prices when you least expect new orders to be coming in.

<p>
 <b>&nbsp;Other human factors to keep an eye on:</b><br />
1) Editing product lists cleanly and accurately<br />
2) Installing the software on an internet server correctly<br />
3) The internet host's server being properly configured and secured
</p>
<p>
&nbsp; <b>Spot check your recordkeeping once in awhile</b>, verifying everything is accurate. If you have any offline records, you might want to spot check those as well.
</p>
